...
#     def initUI(self):
#         self.setWindowTitle('Parking Stream')
...
import matplotlib.pyplot as plt
from matplotlib.backends.backend_qt5agg import FigureCanvasQTAgg as FigureCanvas
from PyQt5.QtWidgets import QLabel, QVBoxLayout, QWidget, QScrollArea, QFormLayout, QHBoxLayout, QPushButton, QGridLayout, QGroupBox
from PyQt5.QtGui import QImage, QPixmap
from PyQt5.QtCore import pyqtSlot
import random
...
class Displayer(QWidget):
    ...
    def initUI(self):
        ...
        # Smaller sizes for image_label and metadata_widget
        self.image_label = QLabel(self)
        self.image_label.setFixedSize(1200, 720)  # Adjusted size

        self.metadata_layout = QFormLayout()
        self.metadata_widget = QWidget()
        self.metadata_widget.setLayout(self.metadata_layout)
        self.metadata_widget.setFixedWidth(300)  # Adjusted width
